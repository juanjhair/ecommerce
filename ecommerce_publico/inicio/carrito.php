		...
		<div class="card-body">
			...
			<form action="confirmacion.php" method="post" autocomplete="off">
				...
				<div class="form-group">
					<input  required type="text" name="nombre" placeholder="Nombre completo" class="form-control">
				</div>
				<div class="form-group">
					<input required type="text" name="calle" placeholder="Calle y numero" class="form-control">
				</div>
				<div class="form-group">
					<input required type="text" name="colonia" placeholder="Colonia" class="form-control">
				</div>
				<div class="form-group">
					<input required type="text" name="cp" placeholder="Codigo postal" class="form-control">
				</div>
				<div class="form-group">
					<div class="row">
						<div class="col">
