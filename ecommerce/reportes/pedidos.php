					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								onclick="bootbox.confirm('Seguro que desea realizar esta accion', function(result){ 
									if (result == true)
										{ 
											location.href='enviar_producto.php?clave=<?php echo $f['clave'] ?>';
										} 
									})"><span class="material-icons" >local_shipping</span></a>
							</td>
