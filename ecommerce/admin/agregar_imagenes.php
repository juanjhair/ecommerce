...
<div class="container" style="margin-top: 1%;">
    <div class="card text-white bg-secondary">
        ...
        <div class="card-body">
            <h4 class="card-title"><img src="<?php echo $f['foto']?>" width="100" height="100" class="rounded-circle" alt=""> <?php echo $f['producto'] ?></h4>
    ...
    <div class="row">
        ...
        <div class="col-4">
            ...
            <a href="#" onclick="bootbox.confirm('Deseas realizar esta accion',
             function(result){
                 if (result == true)
                 { location.href='eliminar_imagenes.php?clave_producto=<?php echo $clave ?>
                 &clave_img=<?php echo $f_img['clave'] ?>
                 &ruta=<?php echo $f_img['ruta'] ?>'; }})" >
                 <img src="<?php echo $f_img['ruta'] ?>" class="card-img-top">
            </a>
